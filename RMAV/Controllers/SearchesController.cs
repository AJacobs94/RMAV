...
namespace RMAV.Controllers
{
    public class SearchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Title,Genre,Price")] Search search)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Title,Genre,Price")] Search search)
        {
            if (id != search.ID)
            {
                return NotFound();
